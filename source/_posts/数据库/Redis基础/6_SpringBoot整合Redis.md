...
SpringBoot对Jedis的支持，在1.×版本的时候，SpringBoot的底层还是使用Jedis来连接Redis的，但是在2.×版本后，就换成了Lettuce。两者的区别如下：
...
> 在实际工作中，不可能用**RedisTemplate** 来操作Redis的，因为实在太繁琐，所以一般自定义一个RedisUtils工具类来操作Redis
